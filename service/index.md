...
Regular reviewer for ACM Transactions on Database Systems (TODS), the VLDB Journal, IEEE Transactions on Knowledge and Data Engineering (TKDE) and IEEE Transactions on Parallel and Distributed Systems (TPDS). Proposal reviewer for NSERC and MITACS.

## Recognition

Distinguished Reviewer Awards: SIGMOD 2025 and PVLDB 2018.
